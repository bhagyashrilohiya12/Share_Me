...
class ReviewCounterBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print("user email : ${session.user!.toJSON()}");
    print("reviewCount  : ${session.reviewCount.toString()}");
                        ...
                        switch (snapshot.connectionState) {
                          ...
                          default:
                            if (snapshot.hasError)
                              ...
                              return snapshot.data==null?Text(""):Text("${snapshot.data.toString()}", style: CPRTextStyles.cardTitle);
                        }
                      },
                    ),
                  ),
