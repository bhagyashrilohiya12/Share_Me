...
class CalendarView extends StatefulWidget {
  ...
  Map<DateTime, List<Review>>  events =  {};
...
class CalendarState extends State<CalendarView> {
  ...
  @override
  void initState() {
    events = widget.events.map((key,value) => MapEntry(key,value.map((e) => CleanCalendarEvent(
      "",
  ...
  Widget _getCalenderClean() {
    return Calendar(
      ...
      //selected
      selectedColor: Theme.of(context).accentColor, //selected day background circle color
      ...
      //event
      eventColor: Theme.of(context).accentColor,    //event : not used event
      eventDoneColor: Theme.of(context).accentColor, //event : not used event
